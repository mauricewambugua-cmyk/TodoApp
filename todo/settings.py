...
SECRET_KEY = 'django-insecure-%5$iz(qtra_fx5ut0sby0f6_g1boi3tsf9@5c6fl_@=4h0sy&1'
...
TEMPLATES = [
    {
        ...
        # include a top-level templates directory and let APP_DIRS find app templates
